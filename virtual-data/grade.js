...
module.exports = function(){
  ...
  for(var i = 0; i < 413; i++){
    ...
    line.push([17,18,19,20,21,22,23,24][parseInt(Math.random() * 7, 10)]);
    ...
    line.push(['大一','大二','大三','大四'][parseInt(Math.random() * 3, 10)]);
    line.push('本科');
    line.push([13900000000,15200000000,18600000000,13800000000,18200000000][parseInt(Math.random() * 4, 10)]+parseInt(Math.random() * 10000000, 10));
